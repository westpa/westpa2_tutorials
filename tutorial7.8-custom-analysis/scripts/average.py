...
# Note that this is performing manual normalization of the fluxes
# by the steady-state populations. You could alternatively specify
# different options for "evolution" in the analysis section of your
# west.cfg file and let w_ipa take care of the averaging automatically.
